...
noremap   za
noremap #K :call ReadMan("3")
noremap $K :call ReadMan("4")
noremap %K :call ReadMan("5")
noremap + :tabn
nnoremap ,s :so ~/config/vimrc
nnoremap ,proj :source ~/config/oblovim/cproj.vim
noremap ,cc :call CompileOne()
noremap ,scr :call SetScratchBuf(expand('%'))
noremap ,see zR
vnoremap ,s :call SwapVisual()
noremap ,9 9gt
noremap ,8 8gt
noremap ,7 7gt
noremap ,6 6gt
...
noremap ,1 1gt
noremap ,td :tabdo
noremap ,sj :rightb sp:e 
noremap ,sk :sp:e 
noremap ,vsl :rightb vsp:e 
noremap ,vsh :vsp:e 
noremap ,wd :windo
noremap ,conf :call SetConfigTab()
noremap ,scpp :so ~/config/oblovim/filetype/cpp.vim
noremap ,spy :so ~/config/oblovim/filetype/python.vim
noremap ,sc :so ~/config/oblovim/filetype/c.vim
noremap ,svi :so ~/config/oblovim/filetype/vim.vim
onoremap ,s :so ~/config/vimrc
noremap ,hls :set hlsearch!
noremap ,sp :set paste!
noremap ,SW :tabdo windo set wrap!1gt
noremap ,sw :set wrap!
noremap @K :call ReadMan("2")
vnoremap C :call CommentVisual()
nnoremap C :call Comment1Line()
noremap K :call ReadMan("")
noremap _ :tabp
nmap gx <Plug>NetrwBrowseX
vnoremap rr d`>I
noremap ss :so %
vnoremap u :call UncommentVisual()
nmap <F1> :Stdheader
nnoremap <silent> <Plug>NetrwBrowseX :call netrw#NetrwBrowseX(expand("<cWORD>"),0)
noremap <S-Right> :vertical res +5
noremap <S-Left> :vertical res -5
noremap <S-Down> :res +5
noremap <S-Up> :res -5
...
badd +11 Makefile
badd +1 ~/_git/nggg_db
badd +17 include/pf.h
badd +1 include/redbase.h
badd +1 include/pf_hashtable.h
badd +3 src/pf/pf_hashtable.cc
badd +1 include/linkedlist.h
badd +1 include/pf/pf_hashtable.h
badd +1 src/ftrb/error.cpp
badd +1 src/pf/pf_buffermgr.cc
badd +14 src/pf/pf_error.cc
badd +1 src/pf/pf_pagehandle.cc
badd +1 src/pf/pf_filehandle.cc
badd +1 src/pf/pf_manager.cc
badd +1 include/pf/pf_buffermgr.h
...
wincmd w
argglobal
edit ~/_git/nggg_db/src/ftrb/error.cpp
...
wincmd w
argglobal
edit ~/_git/nggg_db/include/linkedlist.h
inoremap <buffer> ,print ft_printf(");f)i
inoremap <buffer> ,str std::string
inoremap <buffer> ,s std::
setlocal autoindent
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 86 - ((67 * winheight(0) + 40) / 81)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
86
...
wincmd w
argglobal
edit ~/_git/nggg_db/include/pf/pf_hashtable.h
inoremap <buffer> ,print ft_printf(");f)i
inoremap <buffer> ,str std::string
inoremap <buffer> ,s std::
setlocal autoindent
...
wincmd w
argglobal
edit ~/_git/nggg_db/src/pf/pf_hashtable.cc
inoremap <buffer> ,print std::cout <<  << std::endl;2F i
inoremap <buffer> ,str std::string
inoremap <buffer> ,s std::
setlocal autoindent
...
wincmd w
argglobal
edit ~/_git/nggg_db/include/pf/pf_internal.h
inoremap <buffer> ,print ft_printf(");f)i
inoremap <buffer> ,str std::string
inoremap <buffer> ,s std::
setlocal autoindent
...
wincmd w
argglobal
edit ~/_git/nggg_db/src/pf/pf_manager.cc
inoremap <buffer> ,print std::cout <<  << std::endl;2F i
inoremap <buffer> ,str std::string
inoremap <buffer> ,s std::
setlocal autoindent
...
wincmd w
argglobal
edit ~/_git/nggg_db/src/pf/pf_filehandle.cc
inoremap <buffer> ,print std::cout <<  << std::endl;2F i
inoremap <buffer> ,str std::string
inoremap <buffer> ,s std::
setlocal autoindent
...
wincmd w
argglobal
edit ~/_git/nggg_db/src/pf/pf_pagehandle.cc
inoremap <buffer> ,print std::cout <<  << std::endl;2F i
inoremap <buffer> ,str std::string
inoremap <buffer> ,s std::
setlocal autoindent
...
wincmd w
argglobal
edit ~/_git/nggg_db/include/pf/pf_buffermgr.h
inoremap <buffer> ,print ft_printf(");f)i
inoremap <buffer> ,str std::string
inoremap <buffer> ,s std::
setlocal autoindent
...
wincmd w
argglobal
edit ~/_git/nggg_db/src/pf/pf_buffermgr.cc
inoremap <buffer> ,print std::cout <<  << std::endl;2F i
inoremap <buffer> ,str std::string
inoremap <buffer> ,s std::
setlocal autoindent
...
wincmd w
argglobal
edit ~/_git/nggg_db/include/rm/rm_record.hpp
inoremap <buffer> ,print std::cout <<  << std::endl;2F i
inoremap <buffer> ,str std::string
inoremap <buffer> ,s std::
setlocal autoindent
...
wincmd w
argglobal
edit ~/_git/nggg_db/src/rm/rm_record.cpp
inoremap <buffer> ,print std::cout <<  << std::endl;2F i
inoremap <buffer> ,str std::string
inoremap <buffer> ,s std::
setlocal autoindent
...
wincmd w
argglobal
edit ~/_git/nggg_db/include/rm/rm_manager.hpp
inoremap <buffer> ,print std::cout <<  << std::endl;2F i
inoremap <buffer> ,str std::string
inoremap <buffer> ,s std::
setlocal autoindent
...
wincmd w
argglobal
edit ~/_git/nggg_db/src/rm/rm_manager.cpp
inoremap <buffer> ,print std::cout <<  << std::endl;2F i
inoremap <buffer> ,str std::string
inoremap <buffer> ,s std::
setlocal autoindent
